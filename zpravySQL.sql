...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Úte 21. zář 2021, 16:30
...
INSERT INTO `autor` (`ID`, `name`, `email`, `password`) VALUES
(1, 'Zdeněk Burdík', '', ''),
(2, 'Eva Buchtová', '', ''),
(3, 'Matyáš Barac', '', ''),
(4, 'Aleš Stránský', '', ''),
(5, 'Vilém Bílí', '', ''),
(6, 'Ahoj', 'robokopjenej@gmail.com', '$2y$10$iNfInSuMEXn3hfbbXrCTku3DchbNnib6N/zKdxhy8AUK8K6xn3MM2');
